...
Label = Label(fram, text="Don't have an account? ", fg='black', bg='white', font=('Microsoft YaHei UI Light', 9))
Label.place(x=75, y=270)

sign_up = Button(fram, width=6, text='Sign up', command=signup, border=0, bg='white', cursor='hand2', fg='#57a1f8')
